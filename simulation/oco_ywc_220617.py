...
def pre_cld(sat, cth=None, scale_factor=1.0, solver='3D'):
    ...
    if cth is None:
        ...
        cth        = interpolate.griddata(points, cth0[logic_cth], (lon, lat), method='cubic')#'nearest')
...
def susan_case(band_tag, cfg_info):
    ...
    for wavelength in wvls:
        for solver in ['IPA', '3D']:
            cal_mca_rad_oco2(date, band_tag, sat0, wavelength, fname_idl=fname_idl, cth=None, scale_factor=1.0, sfc_scale=True, sfc_replace=True, fdir=fdir_tmp, solver=solver, overwrite=True, photons=2.5e6)
    # ===============================================================
