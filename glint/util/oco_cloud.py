...
from util.oco_util import path_dir
...
def cdata_cld_ipa(sat0, fdir_cot, zpt_file, cfg_info, plot=True):
    ...
    frac0     = 1.0 - cld_frac0
    scale_factor = 1.08
    # ocean: use 650 instead of 470 nm
    indices_x0, indices_y0 = cloud_mask_rgb(rgb, extent, lon_2d, lat_2d, ref_2d, alb_650,
    ...
    mask = np.isnan(cer_ipa0[indices_x, indices_y])
    cer_ipa0[indices_x[logic_thick & mask], indices_y[logic_thick & mask]]  = 25
    cer_ipa0[indices_x[logic_thin & mask] , indices_y[logic_thin & mask]] = 10
    ...
    # perform wind correction on cot_ipa0, cer_ipa0, and cot_ipa0
    #/--------------------------------------------------------------\#
    Nx, Ny = ref_2d.shape
    ...
    # perform parallax and wind corrections on cot_ipa0, cer_ipa0, and cot_ipa0
    #/--------------------------------------------------------------\#
    Nx, Ny = ref_2d.shape
    ...
    with h5py.File(f'{sat0.fdir_pre_data}/pre-data.h5', 'r+') as f0:
        ...
        group_data = {'mod/cld/cot_ipa_650': cot_ipa0_650,
                      ...
                      'mod/cld/cot_ipa0': cot_ipa_,
                      'mod/cld/cer_ipa0': cer_ipa_,
                      'mod/cld/cth_ipa0': cth_ipa_,
                      'mod/cld/cot_ipa': cot_ipa,
                      'mod/cld/cer_ipa': cer_ipa,
                      'mod/cld/cth_ipa': cth_ipa,
                      'mod/cld/logic_cld_650': (cld_msk==1),
                      'mod/cld/logic_cld_3d_650': (cld_msk_3d_650==1),
