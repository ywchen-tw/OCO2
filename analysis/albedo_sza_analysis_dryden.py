...
def coarsening(OCO_class, size=3):
    ipa0 = coarsening_subfunction(OCO_class.rad_clr, OCO_class.cld_position, size)
    ipa  = coarsening_subfunction(OCO_class.rad_c1d, OCO_class.cld_position, size)
    c3d  = coarsening_subfunction(OCO_class.rad_c3d, OCO_class.cld_position, size)
    ipa0_std = coarsening_subfunction(OCO_class.rad_clrs, OCO_class.cld_position, size)
    ipa_std  = coarsening_subfunction(OCO_class.rad_c1ds, OCO_class.cld_position, size)
    c3d_std   = coarsening_subfunction(OCO_class.rad_c3ds, OCO_class.cld_position, size)
...
def coarsening_subfunction(rad_mca, cld_position, size):
    ...
    rad_mca_mask_cld[cld_position==1][...] = -999999
    for i in range(lams):
