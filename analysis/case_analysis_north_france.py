...
def main(cfg_name='20161023_north_france_test.csv'):
    ...
    if 1:#not os.path.isfile(f'o2a_para_{compare_num}_north_france.csv'):
        if not os.path.isfile(f'20161023_north_france_test_o2a.pkl'):
            ...
            file_o1 = open(f'20161023_north_france_test_o2a.pkl', 'wb') 
            pickle.dump(o1, file_o1)

            file_o2 = open(f'20161023_north_france_test_wco2.pkl', 'wb')
            pickle.dump(o2, file_o2)

            file_o3 = open(f'20161023_north_france_test_sco2.pkl', 'wb') 
            ...
            with open(f'20161023_north_france_test_o2a.pkl', 'rb') as f:
                o1 = pickle.load(f)
            with open(f'20161023_north_france_test_wco2.pkl', 'rb') as f:
                o2 = pickle.load(f)
            with open(f'20161023_north_france_test_sco2.pkl', 'rb') as f:
                o3 = pickle.load(f)
    ...
    f.tight_layout()
    f.savefig(f'north_france_surface_altitude.png', dpi=300)
    ...
    ax.set_ylabel('Latitude ($^\circ$N)', fontsize=label_size)
    f.tight_layout()
    f.savefig(f'north_france_cloud_distance.png', dpi=300)
    # plt.show()
    ...
    ax.set_ylabel('Latitude ($^\circ$N)', fontsize=label_size)
    f.tight_layout()
    f.savefig(f'north_france_o2a_conti_{rad_c3d_compare}.png', dpi=300)
    # plt.show()
    ...
    f.tight_layout()
    f.savefig(f'north_france_o2a_{slope_compare}.png', dpi=300)
