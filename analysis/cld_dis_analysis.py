...
from util.oco_cfg import grab_cfg, ax_lon_lat_label
...
def main(cfg_csv='20181018_central_asia_2_test4.csv'):
    ...
    for ax, cfg in zip([ax21, ax22, ax23, ax24], csv_list):
    ...
    for ax, label_text in zip(ax_list, label_list):
