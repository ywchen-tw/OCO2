...
def main(cfg_name='20181018_central_asia_2_470cloud_test2.csv'):
    ...
    if not os.path.isfile(f'o2a_para_{compare_num}.csv'):
        for alb in [0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.4, 0.5]:
            for sza in [30, 45, 60]:
                if not os.path.isfile(f'20181018_central_asia_2_470cloud_test_sfc_alb_{alb:.3f}_sza_{sza:.1f}_o2a.pkl'):
                    ...
                    file_o1 = open(f'20181018_central_asia_2_470cloud_test_sfc_alb_{alb:.3f}_sza_{sza:.1f}_o2a.pkl', 'wb') 
                    pickle.dump(o1, file_o1)

                    # file_o2 = open(f'20181018_central_asia_2_470cloud_test_sfc_alb_{alb:.3f}_sza_{sza:.1f}_wco2.pkl', 'wb')
                    # pickle.dump(o2, file_o2)

                    # file_o3 = open(f'20181018_central_asia_2_470cloud_test_sfc_alb_{alb:.3f}_sza_{sza:.1f}_sco2.pkl', 'wb') 
