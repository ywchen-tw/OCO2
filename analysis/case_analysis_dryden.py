...
def main(cfg_name='20190209_dryden_470cloud.csv'):
    ...
    if not os.path.isfile(f'o2a_para_{compare_num}_dryden.csv'):
        if not os.path.isfile(f'20190209_dryden_470cloud_o2a.pkl'):
            ...
            file_o1 = open(f'20181018_dryden_470cloud_test2_o2a.pkl', 'wb') 
            pickle.dump(o1, file_o1)

            file_o2 = open(f'20181018_dryden_470cloud_test2_wco2.pkl', 'wb')
            pickle.dump(o2, file_o2)

            file_o3 = open(f'20181018_dryden_470cloud_test2_sco2.pkl', 'wb') 
            ...
            with open(f'20181018_dryden_470cloud_test2_o2a.pkl', 'rb') as f:
                o1 = pickle.load(f)
            with open(f'20181018_dryden_470cloud_test2_wco2.pkl', 'rb') as f:
                o2 = pickle.load(f)
            with open(f'20181018_dryden_470cloud_test2_sco2.pkl', 'rb') as f:
                o3 = pickle.load(f)
    ...
    png       = ['../simulation/data/20190209_dryden_470cloud_20190209/aqua_rgb_2019-02-09_-118.45--117.35-34.15-35.75.png',
             [-118.45, -117.35, 34.15, 35.75]]
    img = png[0]
    wesn= png[1]
    ...
    f.tight_layout()
    f.savefig(f'dryden_surface_altitude.png', dpi=300)
    ...
    ax.set_ylabel('Latitude ($^\circ$N)', fontsize=label_size)
    f.tight_layout()
    f.savefig(f'dryden_cloud_distance.png', dpi=300)
    # plt.show()
    ...
    ax.set_ylabel('Latitude ($^\circ$N)', fontsize=label_size)
    f.tight_layout()
    f.savefig(f'dryden_o2a_conti_{rad_c3d_compare}.png', dpi=300)
    # plt.show()
    ...
    f.tight_layout()
    f.savefig(f'dryden_o2a_{slope_compare}.png', dpi=300)
    plt.show()
