...
def cdata_sat_raw(sat0, overwrite=False, plot=True):
    ...
    if os.path.isfile(f'{sat0.fdir_out}/pre-data.h5') and not overwrite:
        ...
        cld_mask0  = modl2.data['Cloud_Mask_1km']
        _, _, cld_mask_2d_l2 = er3t.util.grid_by_lonlat(lon0, lat0, cld_mask0, lon_1d=lon_1d, lat_1d=lat_1d, method='nearest')
        cld_mask_2d_l2[cld_mask_2d_l2<=0.0] = np.nan

        # g2['cot_l2'] = cot_2d_l2
        # g2['cer_l2'] = cer_2d_l2
        # g2['cth_l2'] = cth_2d_l2
        g2.update({'cot_l2': cot_2d_l2, 'cer_l2': cer_2d_l2, 'cth_l2': cth_2d_l2, 'cld_mask_l2': cld_mask_2d_l2})
        ...
        _, _, AOD_550_land_grid = er3t.util.grid_by_lonlat(mcd04.data['lon']['data'], mcd04.data['lat']['data'], mcd04.data['AOD_550_land']['data'], lon_1d=lon_1d, lat_1d=lat_1d, method='linear')
