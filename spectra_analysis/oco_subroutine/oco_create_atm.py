...
def create_oco_atm(sat=None, o2mix=0.20935, output='zpt.h5'):
    ...
    if sat == None:
        ...
        uprf_l = oco_met['Meteorology/wind_u_profile_met'][...][logic]
        vprf_l = oco_met['Meteorology/wind_v_profile_met'][...][logic]
    ...
    p_edge, t_edge = atm_interp(pprf_lay_mean, hprf_lay_mean, tprf_lay_mean, h_edge)
    p_lay, t_lay, u_lay, v_lay, d_o2_lay, d_co2_lay, d_h2o_lay = atm_interp(pprf_lay_mean, hprf_lay_mean, tprf_lay_mean, h_lay, uprf_lay_mean, vprf_lay_mean, d_o2_lay_mean, d_co2_lay_mean, d_h2o_lay_mean, layer=True)
...
def atm_interp(pressure, altitude, temperature, 
                altitude_to_interp,
                u=None, v=None,
                d_o2=None, d_co2=None, d_h2o=None,
                layer=False):
    ...
    if layer==False:
        ...
        if 1:
            ...
            d_o2_lay, d_co2_lay, d_h2o_lay = np.zeros_like(hn), np.zeros_like(hn), np.zeros_like(hn)
            ...
            return pn, tn, u_lay, v_lay, d_o2_lay, d_co2_lay, d_h2o_lay
        #except:
