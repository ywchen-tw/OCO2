...
class atm_atmmod:
    ...
    def run(self, zpt_file):
        ...
        with h5py.File(zpt_file, 'r') as oco_zpt:
            self.levels = oco_zpt['h_edge'][...]
            self.layers = oco_zpt['h_lay'][...]
            self.lev_t = oco_zpt['t_edge'][...]
            self.lay_t = oco_zpt['t_lay'][...]
            self.lev_p = oco_zpt['p_edge'][...]
            self.lay_p = oco_zpt['p_lay'][...]
            self.lev_d_o2 = oco_zpt['d_o2_lev'][...]
            self.lev_d_co2 = oco_zpt['d_co2_lev'][...]
            self.lev_d_h2o = oco_zpt['d_h2o_lev'][...]
            self.lev_d_o3 = oco_zpt['d_o3_lev'][...]
            self.lay_d_o2 = oco_zpt['d_o2_lay'][...]
            self.lay_d_co2 = oco_zpt['d_co2_lay'][...]
            self.lay_d_h2o = oco_zpt['d_h2o_lay'][...]
            self.lay_d_o3 = oco_zpt['d_o3_lay'][...]
    ...
    def interp(self):
        ...
        self.lev['pressure']['data'] = self.lev_p
        self.lev['temperature']['data'] = self.lev_t
        self.lay['pressure']['data'] = self.lay_p
        self.lay['temperature']['data'] = self.lay_t
        # gases
        self.lev['air']['data'] = self.lev_d_o2/0.20935
        self.lev['o2']['data'] = self.lev_d_o2
        self.lev['co2']['data'] = self.lev_d_co2
        self.lev['h2o']['data'] = self.lev_d_h2o
        self.lev['o3']['data'] = self.lev_d_o3
        self.lay['air']['data'] = self.lay_d_o2/0.20935
        self.lay['o2']['data'] = self.lay_d_o2
        self.lay['co2']['data'] = self.lay_d_co2
        self.lay['h2o']['data'] = self.lay_d_h2o
        self.lay['o3']['data'] = self.lay_d_o3
